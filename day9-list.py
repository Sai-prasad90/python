...
q111 = fruits.index("apple", 1, 5)  # Output: Error (not found in the specified range)
q11 = fruits.index("apple")         # Output: 0 (index of the first occurrence)
q1 = fruits.index("apple", 2)       # Output: 4 (index of the second occurrence)
print(q1)
...
# Sorting the list
cities.sort()
print(citiese)  # Output: Error (variable name is misspelled)
